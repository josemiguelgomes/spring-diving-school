...
public class DataLoaderByService implements ApplicationListener<ContextRefreshedEvent> {
    ...
    // Repositories Beans
    private final CardService cardPointer;
    private final CourseService coursePointer;
    private final InstructorService instructorPointer;
    private final LocationService locationPointer;
    private final SlotLanguageService slotLanguagePointer;
    private final SlotService slotPointer;
    private final StudentService studentPointer;
    ...
    public DataLoaderByService(CardService cardPointer,
                               CourseService coursePointer,
                               InstructorService instructorPointer,
                               LocationService locationPointer,
                               SlotLanguageService slotLanguagePointer,
                               SlotService slotPointer,
                               StudentService studentPointer) {
        this.cardPointer = cardPointer;
        this.coursePointer = coursePointer;
        this.instructorPointer = instructorPointer;
        this.locationPointer = locationPointer;
        this.slotLanguagePointer = slotLanguagePointer;
        this.slotPointer = slotPointer;
        this.studentPointer = studentPointer;
    }
