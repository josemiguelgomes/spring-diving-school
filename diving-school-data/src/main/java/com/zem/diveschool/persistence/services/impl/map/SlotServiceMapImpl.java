...
@Service
@Profile({"default", "map"})
public class SlotServiceMapImpl extends AbstractServiceMapsImpl<Slot, Long>
    ...
    public SlotServiceMapImpl(CourseService courseService, SlotLanguageService slotLanguageService,
